const subjectData = {
    "Stock Market": {
        lessons: [
            { title: "1. What is a Stock?", text: "A stock (or share) represents a tiny piece of ownership in a company. When you buy a share, you become a 'shareholder.'", content: "stock-cert.jpg" },
            { title: "2. The Exchange", text: "Stocks are traded on exchanges like the NYSE or NASDAQ. Think of it as a global digital farmers market for businesses.", content: "nyse-floor.jpg" },
            { title: "3. Bull vs. Bear", text: "A Bull market is charging ahead (prices rising). A Bear market is hibernating (prices falling 20% or more).", content: "bull-vs-bear.png" },
            { title: "4. Dividends", text: "Some companies pay you a 'thank you' in cash just for owning their stock. This is called a dividend.", content: "dividends.jpg" },
            { title: "5. Market Capitalization", text: "The total value of a company. It's calculated by (Price per Share) x (Total Shares).", content: "market-cap.png" },
            { title: "6. Diversification", text: "The 'Don't put all your eggs in one basket' rule. Owning different types of stocks lowers your risk.", content: "diversification-basket.jpg" },
            { title: "7. Index Funds & ETFs", text: "Instead of buying one stock, you buy a 'bundle' (like the S&P 500) that tracks the whole market at once.", content: "etf-bundle.png" },
            { title: "8. P/E Ratio", text: "Price-to-Earnings. It helps you see if a stock is 'expensive' or a 'bargain' compared to how much profit it makes.", content: "pe-ratio.jpg" },
            { title: "9. Volatility", text: "The speed and size of price changes. High volatility means the price swings wildly like a vine in a storm.", content: "volatility-graph.png" },
            { title: "10. Compound Interest", text: "The 'Eighth Wonder of the World.' Reinvesting your gains allows your money to grow exponentially over time.", content: "compounding-growth.jpg" }
        ],
        quiz: [
    ...
    "Taxes": {
        lessons: [
            { title: "1. The Social Contract", text: "Taxes are mandatory contributions to state revenue. They fund public services like roads, schools, and emergency services.", content: "tax-basics.jpg" },
            { title: "2. Progressive vs. Regressive", text: "The US uses a progressive system: as you earn more, your tax rate increases in brackets. Regressive taxes (like sales tax) affect lower incomes more heavily.", content: "tax-brackets-chart.png" },
            { title: "3. The W-4 Form", text: "Filled out when you start a job, this tells your employer how much tax to withhold from your paycheck.", content: "w4-form.jpg" },
            { title: "4. Filing Status", text: "Your status (Single, Married Filing Jointly, Head of Household) determines your standard deduction and tax rates.", content: "filing-status.jpg" },
            { title: "5. Gross vs. Taxable Income", text: "Gross income is everything you earn. Taxable income is what's left after deductions and adjustments.", content: "income-calc.png" },
            { title: "6. Standard Deduction", text: "A flat amount the IRS allows you to subtract from your income, no questions asked, to lower your tax bill.", content: "deduction.jpg" },
            { title: "7. Itemized Deductions", text: "If your specific expenses (mortgage interest, charity) are higher than the standard deduction, you 'itemize' to save more money.", content: "itemizing.jpg" },
            { title: "8. Tax Credits", text: "Credits are more powerful than deductions. While deductions lower taxable income, credits reduce your actual tax bill dollar-for-dollar.", content: "tax-credit-vs-deduction.png" },
            { title: "9. The 1040 Form", text: "This is the main form used by individual taxpayers to file their annual income tax returns.", content: "1040-form.jpg" },
            { title: "10. Tax Deadlines", text: "April 15th is the typical 'Tax Day.' Filing an extension gives you until October, but you still must pay estimated taxes by April.", content: "calendar.jpg" }
        ],
        quiz: [
    ...
    "Life Insurance": {
        lessons: [
            { title: "The Foundation", text: "Life insurance is a legal contract between a policyholder and an insurer...", content: "base.jpg" },
            { title: "Understanding Premiums", text: "A premium is the amount you pay... factors include age and health.", content: "premium.jpg" }
        ],
        quiz: [
